export const ProjectData = [
    {
        id: 1,
        title:"Recallama",
        about:"Using the openFDA API, Recallama allows you to search for FDA drug and food recalls. Users may save recalls to their profile and share recalls via email",
    ...
    },
    {
        ...
        about:"You're here! This is my second project in React and my first project using npm and NodeJS.",
    ...
    },
    {
        ...
        about:"A Flask application that allows users to view information on movies, login, and add personal ratings to a movie.",
